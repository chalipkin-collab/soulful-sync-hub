    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `אתה עוזר חכם לניהול צבאי. אתה עוזר למפקדים לנהל לוחות זמנים, משימות וחיילים.
ענה בעברית בצורה ברורה וקצרה. השתמש באימוג'ים כשמתאים.
אם שואלים אותך שאלה כללית, ענה עליה בצורה מועילה.
אם שואלים אותך על אירועים, משימות או חיילים ספציפיים - תן תשובה כללית ומועילה.`
          },
          ...messages,
        ],
        stream: true,
